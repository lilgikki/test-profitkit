...
/* harmony export */ });
var counter = document.querySelectorAll('.slider__counts');
var checkCounter = function checkCounter() {
  if (counter) {
    counter.forEach(function (count) {
      var num = count.querySelector('.slider__count-add');
      count.querySelector('.slider__count--min').addEventListener('click', function () {
        if (num.textContent > 1) {
          num.textContent--;
        }
      });
      count.querySelector('.slider__count--plus').addEventListener('click', function () {
...
/* harmony export */ });
/* harmony import */ var _swiper_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./swiper.js */ "./js/swiper.js");

var sliderlList = document.getElementById('slider');
var sliderItems = function sliderItems() {
  if (sliderlList) {
...
var removeActive = function removeActive(i) {
  var actPic = i.querySelector('.slider__img-wrapper--act');
  var actTab = i.querySelector('.slider__tab--act');
...
/* harmony import */ var _counter_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./counter.js */ "./js/counter.js");
/* harmony import */ var _tabs_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tabs.js */ "./js/tabs.js");



window.addEventListener('DOMContentLoaded', function () {
  (0,_slider_js__WEBPACK_IMPORTED_MODULE_0__.sliderItems)();
  (0,_counter_js__WEBPACK_IMPORTED_MODULE_1__.checkCounter)();
  (0,_tabs_js__WEBPACK_IMPORTED_MODULE_2__.changeImg)();
});
})();
